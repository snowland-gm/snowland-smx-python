...
class FQP(object):
    def __init__(self, coeffs, modulus_coeffs):
        ...
        self.__class__.degree = len(self.modulus_coeffs)
...
class FQ2(FQP):
    def __init__(self, coeffs):
        self.mc_tuples = [(0, 1)]
        super(FQ2, self).__init__(coeffs, modulus_coeffs=[1, 0])
...
class FQ12(FQP):
    def __init__(self, coeffs):
        ...
        super(FQ12, self).__init__(coeffs, modulus_coeffs=FQ12_modulus_coeffs)
